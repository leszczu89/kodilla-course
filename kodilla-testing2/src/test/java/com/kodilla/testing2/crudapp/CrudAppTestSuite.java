...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://leszczu89.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("paulinarudz@wp.pl");		        // [3]
        driverTrello.findElement(By.id("password")).sendKeys("Leszczu1!");		    // [4]
        WebElement el = driverTrello.findElement(By.id("login"));
        el.submit();									                                // [5]

        Thread.sleep(4000);								                            // [6]

        driverTrello.findElement(By.id("password")).sendKeys("Leszczu1!");		    // [7]
        driverTrello.findElement(By.id("login-submit")).submit();

        Thread.sleep(4000);								                            // [8]

        driverTrello.findElements(By.xpath("//a[contains(@class, \"board-tile\")]")).stream()  // [9]
        ...
        result = driverTrello.findElements(By.xpath("//div[@id=\"board\"]//div[contains(@class, \"list-cards\")]//span[contains(@class, \"list-card-title\")]")).stream()		        // [13]
    ...
    private void deleteCrudAppTestTask(String taskName) throws InterruptedException {
        ...
        driver.findElements(
                ...
                .forEach(theForm -> theForm.findElements(By.xpath(".//button[@class=\"datatable__button\"]")).stream()
                    .filter(anyButton -> anyButton.getText().equals("Delete"))
